...
/**
 * 参见{@link android.widget.VideoView}
 * @author <a href="mailto:jenly1314@gmail.com">Jenly</a>
 */
public final class MeasureHelper implements IMeasureSurface {
    ...
    public void doMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mCurrentAspectRatio == AspectRatio.AR_MATCH_PARENT) {
            ...
            if (widthSpecMode == View.MeasureSpec.AT_MOST && heightSpecMode == View.MeasureSpec.AT_MOST) {
                ...
                switch (mCurrentAspectRatio) {
                    case AspectRatio.AR_16_9_FIT_PARENT:
                        displayAspectRatio = 16.0f / 9.0f;
                        if (mVideoRotationDegree == 90 || mVideoRotationDegree == 270)
                            displayAspectRatio = 1.0f / displayAspectRatio;
                        break;
                    case AspectRatio.AR_4_3_FIT_PARENT:
                        displayAspectRatio = 4.0f / 3.0f;
                        if (mVideoRotationDegree == 90 || mVideoRotationDegree == 270)
                            displayAspectRatio = 1.0f / displayAspectRatio;
                        break;
                    case AspectRatio.AR_ASPECT_FIT_PARENT:
                    case AspectRatio.AR_ASPECT_FILL_PARENT:
